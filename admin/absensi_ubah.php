...
<form method="post">
	...
	if (isset($_POST['cetak'])) {
		echo "<script>document.location.href='?menu=ubahabsen$rombel=$_POST[rombel]&thn=$_POST[thn]$bln=$_POST[bln]
	...
	<table border="1" cellspacing="0" align="center">
		...
		<tr>
			...
			<td><input type="radio" name="keterangan<?php echo $r['nis']?>" value="sakit"<?php echo $hadir ?>/></td>
			<td><input type="radio" name="keterangan<?php echo $r['nis']?>" value="ijin"<?php echo $hadir ?>/></td>
			<td><input type="radio" name="keterangan<?php echo $r['nis']?>" value="alpa"<?php echo $hadir ?>/></td>
		</tr>
